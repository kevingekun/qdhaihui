...
class HisenseInventory
{
    ...
    const URL = 'http://172.16.34.91:8080/api';
    //const URL = 'http://172.16.13.167:8080/api';
    ...
    * @return $this
    */
    public function warehouseInventory($sku_id, $warehouse_code='', $pageIndex='1', $pageSize=self::MAX_WAREHOUSE)
    {
        $this->_method = self::METHOD_WAREHOUSE_INVENTORY;
...
//            'warehouseCode' => $warehouse_code,
    ...
    */
    public function query()
    {
        ...
        //$sign_str = 'testmall.areaInventory.queryInventoryQuantity{"sku_id":"1TE32Q7TCN9B","warehouseCode":"D531","pageIndex":"1","pageSize":1000}239B5F335E23F1EBE0532B2B10AC37D6';
        ...
        $post_data = array(
            ...
            //'Data' => '{"sku_id":"1TE32Q7TCN9B","warehouseCode":"D531","pageIndex":"1","pageSize":1000}',
        );

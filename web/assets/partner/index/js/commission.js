                ...
                if (!$.isEmptyObject(data.data)) {
                    ...
                    $.each(data.data, function (k, v) {
                        html += '<div  class="row no-gutter">' +
                            '<div class="col-20">' + v.create_time + '</div>' +
                            '<div class="col-20">' + v.type_string + '</div>' +
                            '<div class="col-20">'+'￥' + v.money + '</div>' +
                            '<div class="col-20">' + (v.fans_id == '' ? '　' : v.fans_id) + '</div>' +
                            '<div class="col-20">' + v.status_string + '</div>' +
                            '</div>';
                    });
